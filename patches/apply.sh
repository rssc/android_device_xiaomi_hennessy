...
cd ../..
cd vendor/cm
git apply -v ../../device/xiaomi/hennessy/patches/vendor_cm/0001-enable-ota-nightly.patch
cd ../..
cd packages/apps/CMUpdater
git apply -v ../../../device/xiaomi/hennessy/patches/packages_apps_CMUpdater/0001-enable-ota-updates.patch
cd ../../..
