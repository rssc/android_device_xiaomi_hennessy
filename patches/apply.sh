...
git apply -v ../../device/xiaomi/hennessy/patches/framework_base/0004-NetworkMonitor-use-g.cn-for-connectivity-check.patch
git apply -v ../../device/xiaomi/hennessy/patches/framework_base/0005-SystemUI-add-new-carrier-name-override-rule-for-Chin.patch
git apply -v ../../device/xiaomi/hennessy/patches/framework_base/0006-add-com.mediatek-for-build.patch
